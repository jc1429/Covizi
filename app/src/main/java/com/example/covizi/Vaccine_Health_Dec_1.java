...
public class Vaccine_Health_Dec_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vaccine_health_dec1);
    ...
    public void goToStep2(View view) {
        ...
        Intent i = new Intent(Vaccine_Health_Dec_1.this, Vaccine_Health_Dec_2.class);
        startActivity(i);
    }
