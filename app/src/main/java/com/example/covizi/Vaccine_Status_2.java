...
public class Vaccine_Status_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vaccine_status2);
    ...
    public void Vaccine_Status3(View view) {
        Intent i = new Intent(Vaccine_Status_2.this, Vaccine_Health_Dec_1.class);
        startActivity(i);
    }
    public void back(View view) {

        Intent i = new Intent(Vaccine_Status_2.this, HomeActivity.class);
        startActivity(i);
    }
}