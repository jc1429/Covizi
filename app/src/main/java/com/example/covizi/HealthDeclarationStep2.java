...
public class HealthDeclarationStep2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_health_declaration_step2);

        radioGroup1a = HealthDeclarationStep2.this.findViewById(R.id.spinnerQ1A_Ans);
        radioGroup1b = HealthDeclarationStep2.this.findViewById(R.id.spinnerQ1B_Ans);
        radioGroup1c = HealthDeclarationStep2.this.findViewById(R.id.spinnerQ1C_Ans);
        radioGroup1d = HealthDeclarationStep2.this.findViewById(R.id.spinnerQ1D_Ans);
        radioGroup1e = HealthDeclarationStep2.this.findViewById(R.id.spinnerQ1E_Ans);
        radioGroup1f = HealthDeclarationStep2.this.findViewById(R.id.spinnerQ1F_Ans);
        radioGroup1g = HealthDeclarationStep2.this.findViewById(R.id.spinnerQ1G_Ans);
        radioGroup2 = HealthDeclarationStep2.this.findViewById(R.id.spinnerQ2_Ans);
        radioGroup3 = HealthDeclarationStep2.this.findViewById(R.id.spinnerQ3_Ans);
        radioGroup4 = HealthDeclarationStep2.this.findViewById(R.id.spinnerQ4_Ans);
        update_btn = HealthDeclarationStep2.this.findViewById(R.id.button_submit_status);
        ...
        update_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!q1a.isEmpty() && !q1b.isEmpty() && !q1c.isEmpty() && !q1d.isEmpty() &&
                    ...
                    databaseHelper.insertUserSymptomData(ic_num,q1a,q1b,q1c,q1d,q1e,q1f,q1g,q2,q3,q4);
                    Toast.makeText(getApplicationContext(),"Register successfully.",Toast.LENGTH_SHORT).show();
                    Intent i = new Intent(HealthDeclarationStep2.this, HomeActivity.class);
                    startActivity(i);
                }else{
    ...
    public void back(View view) {
        Intent i = new Intent(HealthDeclarationStep2.this, HealthDeclarationStep1.class);
        startActivity(i);
    }
