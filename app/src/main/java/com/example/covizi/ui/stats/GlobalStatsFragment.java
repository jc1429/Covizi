...
public class GlobalStatsFragment extends Fragment {
    ...
    private GlobalStatsViewModel mViewModel;
    ...
    TextView DateTimeTotalCase, DateTimeTotalRecovered, DateTimeTotalDeath, DateTimeTotalActiveCase;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.global_stats_fragment, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(GlobalStatsViewModel.class);
